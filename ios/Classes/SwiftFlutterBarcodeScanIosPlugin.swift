...
public class SwiftFlutterBarcodeScanIosPlugin: NSObject, FlutterPlugin, BarcodeScannerViewControllerDelegate {
    
    private var result: FlutterResult?
    private var hostViewController: UIViewController?
    
    public static func register(with registrar: FlutterPluginRegistrar) {
        let channel = FlutterMethodChannel(name: "flutter_barcode_scan_ios", binaryMessenger: registrar.messenger())
        let instance = SwiftFlutterBarcodeScanIosPlugin()
